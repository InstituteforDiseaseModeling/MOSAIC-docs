...
metric_tbl <- data.frame(
     Metric            = c("$\\Delta$AIC cut-off",
                           "Effective Sample Size $\\left(\\widehat{\\text{ESS}}\\right)$",
                           "",
                           "Agreement Index $\\left(A\\right)$",
                           "Weight Coefficient of Variation $\\left(\\mathrm{CV}_{\\tilde{\\mathbf w}} \\right)$"),
     
     `Target range`     = c("$\\le 6 \\ \\left(p\\! \\approx \\! 0.05\\right)$",
                            "$\\gt 500$",
                            "$\\gt 1000$",
                            "$\\gt 0.7 \\ \\text{or} \\ 0.8$",
                            "$\\lt 1 \\ \\text{or} \\ 2$"),
     ...
     Source             = c("[Burnham & Anderson 2004](https://journals.sagepub.com/doi/abs/10.1177/0049124104268644)",
