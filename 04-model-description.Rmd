...
tbl <- data.frame(
     ...
     Description = c(
          ...
          "Exponent on infectious individuals in the force of infection numerator. Dual-mode: a single global scalar (broadcast to all metapopulations) or a per-location vector applied elementwise per patch (calibrated per-location by default, with a shared informative prior).",  # alpha_1
          "Exponent on population size in the force of infection denominator; determines density (0) vs frequency (1) dependence. A single global scalar.",  # alpha_2
