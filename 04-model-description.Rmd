...
tbl <- data.frame(
     ...
     Description = c(
          ...
          "Dynamic infection-fatality ratio (per-day mortality hazard) among symptomatic individuals. Decomposed into $\\mu_{j,0}, \\mu_{j,1}, \\mu_{j,\\text{epi}}$; see \\@ref(eq:mu-jt).",  # mu_jt
     ...
     Source = c(
          ...
          "Meta-analysis (see \\@ref(eq:kappa))"   # kappa
     )
)
...
tbl2 <- data.frame(
     ...
     Description = c(
          ...
          "Calibrated (EWMA-smoothed, logit-affine, time-shifted) environmental suitability used in the FOI and decay rate; see \\@ref(eq:psi-star).",
...
tbl <- data.frame(
     ...
     Description = c(
          ...
          "Cholera-attributable mortality among symptomatic individuals (dynamic IFR, see \\@ref(eq:mu-jt)).",
