...
knitr::include_graphics("figures/seasonal_precip_hierarchical_cluster.png")
```
...
df <- read.csv(file.path(getwd(), "figures/wash_table.csv"), stringsAsFactors = FALSE)
...
```{r wash-country, echo=FALSE, fig.align='center', out.width="100%", fig.cap="The optimized weighted mean of WASH variables for AFRO countries"}
...
df <- data.frame(
     ...
     source = c('[Azman et al (2016)](https://www.thelancet.com/journals/langlo/article/PIIS2214-109X(16)30211-X/fulltext)', 
                '[Qadri et al (2016)](https://www.nejm.org/doi/full/10.1056/NEJMoa1510330)', 
                '[Qadri et al (2018)](https://www.thelancet.com/journals/laninf/article/PIIS1473-3099(18)30108-7/fulltext)', 
                '[Malembaka et al (2024)](https://www.thelancet.com/journals/laninf/article/PIIS1473-3099(23)00742-9/fulltext)', 
                '[Malembaka et al (2024)](https://www.thelancet.com/journals/laninf/article/PIIS1473-3099(23)00742-9/fulltext)')
)
...
knitr::include_graphics("figures/immune_durability.png")
```
...
cholera_data_recent <- read.csv(file.path(getwd(), "figures/case_fatality_ratio_2014_2024.csv"), stringsAsFactors = FALSE)
...
library(knitr)
library(kableExtra)
df <- read.csv("./figures/generation_time_weeks.csv")
