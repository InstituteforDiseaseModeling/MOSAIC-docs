...
tbl2 <- data.frame(
     ...
     Description = c(
          ...
          "Reporting lag in days from symptom onset to death reporting.",
     ...
     Distribution = c(
          ...
          "$\\text{Gamma}$ per country (e.g., AGO: $\\text{Gamma}(4, 482.6)$).",
          "$\\mathcal{N}(0, 0.05)$",
          "$\\text{Gamma}(1, 2)$",
     ...
     Source = c(
          ...
          "Surveillance reporting practice.",
          "Derived from reported CFR via $\\mu_{j,0} \\approx \\text{CFR}^{\\text{reported}}_j \\cdot \\rho / \\chi$.",
          "Weakly informative.",
