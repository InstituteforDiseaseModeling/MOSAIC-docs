...
{\emph{
Website under development. Last compiled on 2025-05-21 at 02:29 PM PDT.
}}
...
\end{equation}
Here, shape \(= 2.5\), rate \(= 0.5\), and the mean is given by \(\text{shape} / \text{rate} \approx 5\) days (variance \(= \text{shape} / \text{rate}^2 \approx 10\) days). Previous studies have used a mean of 5 days (\href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7060667/}{Kahn et al.~2020} and \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4880069/}{Azman 2016}); however, means of 3, 5, 7, or 10 days are also plausible (\href{https://journals.plos.org/plosntds/article?id=10.1371/journal.pntd.0001901}{Azman 2012}).
