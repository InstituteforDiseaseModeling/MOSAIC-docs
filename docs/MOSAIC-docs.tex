...
{\emph{
Website under development. Last compiled on 2025-05-15 at 05:22 PM PDT.
}}
...
Using these quantities, we write the \emph{spatial--correlation coefficient} as a set of explicit sums:
\begin{equation}
\mathcal{C}_{ij} = 
